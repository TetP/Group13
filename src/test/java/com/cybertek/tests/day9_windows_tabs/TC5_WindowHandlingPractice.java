...
public class TC5_WindowHandlingPractice {
    WebDriver driver;
    ...
    public void p5_handling_windows(){
        ...
        for (String each:windowHandles){
            ...
            System.out.println("Current WINDOWS HANDLE= "+driver.getWindowHandle());
        }
